...
export async function GET() {
  try {
    ...
    // Crear tablas usando la API de Supabase SQL
    ...
    if (accountsError) {
      try {
        ...
        console.error("Error al crear tabla de cuentas:", error)
      }
    }
    ...
    if (paymentMethodsError) {
      try {
        ...
        console.error("Error al crear tabla de métodos de pago:", error)
      }
    }
    ...
    if (installmentsError) {
      try {
        ...
        console.error("Error al crear tabla de cuotas:", error)
      }
    }
